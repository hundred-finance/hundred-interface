...
const App: React.FC = () => {
    ...
    useEffect(() => {
        ...
        if (addr && addr !== '') onLoadSetAddress(addr);
        ...
        return (
            <ErrorBoundary fallbackRender={errorFallback} onError={myErrorHandler}>
                <Content
                    ...
                    setHndEarned={setHndEarned}
                    setHndBalance={setHndBalance}
                    setHundredBalance={setHundredBalace}
                    updateEarned={updateEarned}
                    setUpdateEarned={setUpdateEarned}
            ...
            <Wrapper sideMenu={sideMenu}>
                {!isTablet && !isMobile ? (
                    <Menu
                        ...
                        network={network}
                        setOpenHundred={setOpenHundred}
                        address={address}
                        setAddress={setAddress}
                        setOpenAddress={setOpenAddress}
                        setSideMenu={setSideMenu}
                        setOpenAirdrop={setOpenAirdrop}
                        airdropSpinner={airdropSpinner}
            ...
            >
                {openAddress ? (
                    ...
                    <HundredMenu
                        ...
                        hndEarned={hndEarned}
                        hndSpinner={hndSpinner}
                        handleCollect={handleCollect}
                        setOpenHundred={setOpenHundred}
                        setSideMenu={setSideMenu}
                        address={address}
                        hndPrice={hndPrice}
                        hundredBalance={hundredBalance}
                    />
                ) : openAirdrop ? (
                    <AirdropMenu
                        airdrops={airdrops}
                        ...
                        setSideMenu={setSideMenu}
                        setOpenAirdrop={setOpenAirdrop}
                        spinner={airdropSpinner}
                        setSpinner={setAirdropSpinner}
                        network={network}
