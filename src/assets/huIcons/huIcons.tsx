...
const ImmunefiLogo: React.FC<Props> = (props: Props) => {
    ...
    return(props.isMobile ? (
        <svg width="36" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path style={style} fillRule="evenodd" clipRule="evenodd" d="M6.50824 11.0549L14.5718 19.2632L22.5493 11.1425L29.0902 17.8008L21.4906 25.5369L19.5355 23.5998L25.2322 17.8008L22.5493 15.0697L14.5718 23.1904L6.50824 14.9821L3.85799 17.6799L9.64133 23.5671L7.68629 25.5042L0 17.6799L6.50824 11.0549Z"/>
            <path style={style} fillRule="evenodd" clipRule="evenodd" d="M22.582 14.982L14.5184 6.77364L6.54091 14.8943L2.28882e-05 8.23604L7.59967 0.499977L9.55471 2.43708L3.85801 8.23604L6.54091 10.9671L14.5184 2.8464L22.582 11.0547L25.2322 8.3569L19.4489 2.46974L21.4039 0.532634L29.0902 8.3569L22.582 14.982Z"/>
            <path style={style} fillRule="evenodd" clipRule="evenodd" d="M13.3147 25.3441L13.3147 20.1725H15.9479L15.9479 25.3441H13.3147Z"/>
            <path style={style} fillRule="evenodd" clipRule="evenodd" d="M13.3147 5.86438L13.3147 0.692822L15.9479 0.692822L15.9479 5.86438L13.3147 5.86438Z"/>
        </svg>
    ) :
...
const DoneIcon: React.FC<Props> = (props: Props) => {
    return (
        <svg style={props.style} xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 48 48" width={`${props.size ? props.size : "48px"}`} height={`${props.size ? props.size : "48px"}`}>
            ...
            <linearGradient id="HoiJCu43QtshzIrYCxOfCb" x1="-15.77" x2="26.403" y1="43.228" y2="43.228" gradientTransform="rotate(134.999 21.287 38.873)" gradientUnits="userSpaceOnUse">
                <stop offset="0" stopColor="#2ac782"/><stop offset="1" stopColor="#21b876"/>
            </linearGradient>
...
const MoneyBagIcon: React.FC<Props> = (props: Props) => {
    return(
        <svg style={props.style} width={`${props.size ? props.size : "20px"}`} height={`${props.size ? props.size : "20px"}`} version="1.1" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            <path d="m12.965 0.095703c-0.15896-0.0022195-0.31064 0.010049-0.46094 0.033203-0.60119 0.092616-1.1046 0.30989-2.0879 0.47852-0.90316 
                  ...
                  1.5-1.5s-0.6775-1.5-1.5-1.5h-1c-0.28206 0-0.5-0.21794-0.5-0.5s0.21794-0.5 0.5-0.5h1 1.5v-1h-1.5v-1h-1z" style={{fill: props.color ? props.color : "#222222"}}/>
            </svg>
    )
}
