        ...
        <div className={`dialog ${props.open ? 'open-dialog' : ''}`}>
            <div ref={ref} className="dialog-box">
                <img
                    ...
                    onClick={() => props.closeMarketDialog()}
                />
                <div className="dialog-title">
                    ...
                    {`${props.market?.isEnterMarket ? 'Disable' : 'Enable'} as Collateral`}
                </div>
                {props.market?.underlying.symbol && (
                    <div className="dialog-content">
                        ...
                        <div className="footer-section">
                            {props.market.isEnterMarket ? (
                                <button
                                    disabled={
                                        +props.market.borrowBalance.toString() > 0 ||
                                        +props.market.supplyBalance.toString() > 0
                                            ? true
                                            : false
                                    }
                                    ...
                                    onClick={() => {
                                        props.market?.underlying.symbol
                                            ? props.handleExitMarket(props.market?.underlying.symbol)
                                            : null;
                                    }}
                                >
                                ...
                                <button
                                    ...
                                    onClick={() => {
                                        props.market?.underlying.symbol
                                            ? props.handleEnterMarket(props.market?.underlying.symbol)
                                            : null;
                                    }}
                                >
