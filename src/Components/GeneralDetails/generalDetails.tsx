...
import {
    ...
    GeneralDetailsItemTitle,
} from './generalDetailsItem';
import './style.css';
            ...
            <GeneralDetailsItem>
                ...
                <GeneralDetailsItemContent>
                    <GeneralDetailsItemContentItem
                        label="Total Supply"
                        value={`$${
                            generalData ? generalData?.allMarketsTotalSupplyBalance.toRound(2, true, true) : '0'
                        }`}
                    />
                    <GeneralDetailsItemContentItem
                        label="Total Staked"
                        value={`$${
                            generalData ? generalData?.allMarketsTotalStakeBalance.toRound(2, true, true) : '0'
                        }`}
                    />
                    <GeneralDetailsItemContentItem
                        label="Total Borrow"
                        value={`$${
                            generalData ? generalData?.allMarketsTotalBorrowBalance.toRound(2, true, true) : '0'
                        }`}
                    />
                    <GeneralDetailsItemContentItem
            ...
            <GeneralDetailsItem>
                ...
                <GeneralDetailsItemContent>
                    ...
                    <GeneralDetailsItemContentItem
                        ...
                        valueDetails={`(${
                            generalData ? generalData?.totalBorrowLimitUsedPercent.toRound(2) : '0'
                        }% Used)`}
                    />
                </GeneralDetailsItemContent>
            </GeneralDetailsItem>
            ...
            <GeneralDetailsItem>
                ...
                <GeneralDetailsItemContent>
                    <GeneralDetailsItemContentItem
                        label="Supply"
                        value={`${
                            generalData && +generalData.totalSupplyBalance.toString() > 0
                                ? BigNumber.parseValue(
                                      (
                                          (+generalData?.yearSupplyInterest.toString() /
                                              +generalData.totalSupplyBalance.toString()) *
                                          100
                                      ).noExponents(),
                                  ).toRound(3, true)
                                : 0
                    ...
                    <GeneralDetailsItemContentItem
                        label="Staking"
                        value={`${
                            generalData && +generalData.totalStakeBalance.toString() > 0
                                ? BigNumber.parseValue(
                                      (
                                          (+generalData?.yearStakeInterest.toString() /
                                              +generalData.totalStakeBalance.toString()) *
                                          100
                                      ).noExponents(),
                                  ).toRound(3, true)
                                : 0
                    ...
                    <GeneralDetailsItemContentItem
                        ...
                        value={`${
                            generalData && +generalData.totalBorrowBalance.toString() > 0
                                ? BigNumber.parseValue(
                                      (
                                          (+generalData?.yearBorrowInterest.toString() /
                    ...
                    <GeneralDetailsItemContentItem
                        label="Net"
                        toolTip="APY on your total outlay (supplied minus borrowed)"
                        value={`${
                            generalData
                                ? BigNumber.parseValue((+generalData?.netApy.toString() * 100).noExponents()).toRound(
                                      3,
                                      true,
                                  )
                                : 0
