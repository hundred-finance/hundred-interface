...
const GeneralDetailsItem: React.FC<Children> = (props: Children) => {
    return <div className="general-details-item">{props.children}</div>;
};
...
const GeneralDetailsItemContent: React.FC<Children> = (props: Children) => {
    return <div className="general-details-item-content">{props.children}</div>;
};

const GeneralDetailsItemContentItem: React.FC<Props> = (props: Props) => {
    return (
        <div
            className={`general-details-item-content-item ${props.className ? props.className : ''}`}
        ...
        >
            ...
            {props.value ? (
                <span className={props.className ? props.className : ''}>
                    {props.value}{' '}
                    {props.valueDetails ? <span className="value-details">{props.valueDetails}</span> : ''}
                </span>
            ) : (
                ''
            )}
