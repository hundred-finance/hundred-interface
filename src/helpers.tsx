...
export const compareLiquidity = (a: CTokenInfo | null, b: CTokenInfo | null): number => {
    if (a && b) {
        if (+a.liquidity.toString() > +b.liquidity.toString()) return -1;
        else if (+a.liquidity.toString() < +b.liquidity.toString()) return 1;
    }
    return 0;
};
...
export const compareHndAPR = (a: CTokenInfo | null, b: CTokenInfo | null): number => {
    if (a && b) {
        ...
        if (aApr.toString() > bApr.toString()) return -1;
        else if (aApr.toString() < bApr.toString()) return 1;
    }
    return 0;
};
