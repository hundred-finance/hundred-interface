...
export const getTokenBalances = async (
    tokens: (CTokenInfo | null)[],
    comptrollerData: Comptroller,
    userAddress: string,
): Promise<(CTokenInfo | null)[] | null> => {
        ...
        const calls: Call[] = tokens.map((t) => {
            if (t) {
                if (t.isNativeToken) {
                    ...
                    const c =
                        t.underlying.address.toLowerCase() === '0x9f8f72aa9304c8b593d555f12ef6589cc3a579a2'
                            ? new Contract(t.underlying.address, MKR_TOKEN_ABI)
                            : new Contract(t.underlying.address, TOKEN_ABI);
